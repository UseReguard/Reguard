#!/usr/bin/env python3
"""Apply migration 004: add article_runtime_assessments table.

Mirrors the style of scripts/migrate_add_agent_repository_audits.py.
"""
...
MIGRATION_FILE = PROJECT_ROOT / "migrations" / "004_article_runtime_assessments.sql"
